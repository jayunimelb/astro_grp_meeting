...
def make_selection():
    ...
    # finish the email
    femail1.write('chair:\t%s (%s)\n'%(selected_presenters[next_monday]['chair'][0],emails[selected_presenters[next_monday]['chair'][0]]))
    femail1.write('speaker1:\t%s (%s)\n'%(selected_presenters[next_monday]['speaker'][0],emails[selected_presenters[next_monday]['speaker'][0]]))
    ...
    femail4.write('chair:\t%s (%s)\n'%(selected_presenters[next4_monday]['chair'][0],emails[selected_presenters[next4_monday]['chair'][0]]))
    femail4.write('speaker1:\t%s (%s)\n'%(selected_presenters[next4_monday]['speaker'][0],emails[selected_presenters[next4_monday]['speaker'][0]]))
