...
ff.write('This email is to inform that you are selected either as an organizer or as a speaker for the group meeting to be held on %s. Please find the details below. \n'%(date.strftime("%A %d. %B %Y")))
ff.write('Organizer: %s \n'%(organisers[0]))
...
ff.write(" It is the organizer's responsibility to update the group meeting minutes on AstroWiki, serve a cake after the meeting and to clean up the refrigerator on Monday of the corresponding week which includes getting rid of unclaimed items. ")
